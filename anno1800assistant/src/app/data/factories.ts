...
export class Factory extends FactoryRaw {
    ...
    GetRequiredCount(populationLevels: PopulationLevel[], factories: Factory[]): number {
        if (!this.Enabled) {
            return 0;
        }
